...
INSERT INTO "public"."category_description" OVERRIDING SYSTEM VALUE VALUES (1, 1, 'Kids', NULL, '[{"id":"r__kids","columns":[{"size":1,"id":"c__kids","data":{"time":1729900000000,"blocks":[{"id":"acc_block_2","type":"paragraph","data":{"text":"Have a look at our kids section"}}],"version":"2.31.0"}}],"size":1,"className":"md:grid-cols-1"}]', NULL, 'Kids', 'Kids', 'Kids', 'kids');
